        ...
        <div className="network-filters-container">
          ...
          <div className="network-filters__filter--alert" >
            ...
            <form action="" className="network-filters__filter--alert-form" />
              <input type="checkbox" />
              <label htmlFor="" className="network-filters__checkbox-text">New Device</label><br/>
              <input type="checkbox" />
              <label htmlFor="" className="network-filters__checkbox-text">Outage</label><br/>
              <input type="checkbox" />
              <label htmlFor="" className="network-filters__checkbox-text">High Device Risk</label><br/>
              <input type="checkbox" />
              <label htmlFor="" className="network-filters__checkbox-text">Device Logon</label>
            <form/>
          </div>
          <div className="network-filters__filter--created">
            ...
            <form action="" className="network-filters__created--filters" />
              <input type="checkbox" />
              <label htmlFor="" className="network-filters__checkbox-text">Less than 1hr ago</label><br/>
              <input type="checkbox"  />
              <label htmlFor="" className="network-filters__checkbox-text">1 - 3hrs ago</label>
            <form/>
          </div>
          <div className="network-filters__filter--importance">
            ...
            <form action="" className="network-filters__importance--filters" />
              <input type="checkbox" />
              <label htmlFor="" className="network-filters__checkbox-text">Low</label><br/>
              <input type="checkbox"  />
              <label htmlFor="" className="network-filters__checkbox-text">High</label>
            <form/>
          </div>
