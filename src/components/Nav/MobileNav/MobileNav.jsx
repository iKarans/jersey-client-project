  ...
  return (
    <div className="mobile-nav">
      <div className="mobile-nav__item mobile-nav--dashboard">
        ...
        <Link to="/dashboard" className="mobile-nav__item--text " onClick={handleClick}>
          Dashboard
        </Link>
      </div>
      <div className="mobile-nav__item">
        <SecurityIcon className="mobile-nav__item--image" />
        <Link to="/security" className="mobile-nav__item--text " onClick={handleClick}>
          Security
        </Link>
      </div>
      <div className="mobile-nav__item">
        <DevicesIcon className="mobile-nav__item--image" />
        <Link to="/devices" className="mobile-nav__item--text " onClick={handleClick}>
          Devices
        </Link>
      </div>
      <div className="mobile-nav__item">
      ...
      <div className="mobile-nav__item">
        ...
        <Link to="/settings" className="mobile-nav__item--text " onClick={handleClick}>
          Settings
        </Link>
      </div>
