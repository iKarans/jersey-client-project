    ...
    return (
        <div className="container">
            <div className="calculation">
                <h1 className="calculation__title">Calculation Summary</h1>
                <p className="calculation__paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae sequi laboriosam asperiores repellat quas dolores excepturi.</p>
                ...
                <div className="calculation__container">
                    <div className="calculation__container--items">
                        ...
                        <p className="calculation__container--paragraph">Hard drives encrypted</p>
                        <img className="calculation__container--image" src={Tick} alt="Green tick"/>
                        <p className="calculation__container--paragraph">Anti-virus and malware installed</p>
                        <img className="calculation__container--image" src={Tick} alt="Green tick"/>
                        <p className="calculation__container--paragraph">No high risk devices detected on network</p>
                        <img className="calculation__container--image" src={Cross} alt="Red-Cross"/>
                        <p className="calculation__container--paragraph" style={{color: '#F08E8E'}}>No SSL Certificates</p>
                    </div>
                </div>
